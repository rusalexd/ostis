...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_sctpClient_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 29, 6)
    ...
    "sctpClient\0done\0\0sctpClient*\0client\0"
};
...
void sctpClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        sctpClient *_t = static_cast<sctpClient *>(_o);
        switch (_id) {
        ...
        {
            typedef void (sctpClient::*_t)(sctpClient * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&sctpClient::done)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject sctpClient::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_sctpClient.data,
      qt_meta_data_sctpClient,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_sctpClient.stringdata))
        return static_cast<void*>(const_cast< sctpClient*>(this));
