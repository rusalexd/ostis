...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_sctpServer_t, stringdata) + ofs \
...
const QMetaObject sctpServer::staticMetaObject = {
    { &QTcpServer::staticMetaObject, qt_meta_stringdata_sctpServer.data,
      qt_meta_data_sctpServer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_sctpServer.stringdata))
